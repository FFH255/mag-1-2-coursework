...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/LeaderboardGetHandler.ResponseBody"
                        }
                    },
                    "400": {
        ...
        "/users/me/leaderboard-positions": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/UsersMeLeaderboardPositionsGetHandler.ResponseBody"
                        }
                    },
                    "401": {
                        "description": "Пользователь не авторизован",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/UsersMeLessonProgressGetHandler.ResponseBody"
                        }
                    },
                    "500": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/UsersMeLessonProgressPostHandler.RequestBody"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/UsersUsernameAvailabilityGetHandler.ResponseBody"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "LeaderboardGetHandler.LeaderboardItem": {
            "type": "object",
            "properties": {
                "accuracy": {
                    "type": "number",
        ...
        "LeaderboardGetHandler.ResponseBody": {
            "type": "object",
            "properties": {
                "leaderboard": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/LeaderboardGetHandler.LeaderboardItem"
                    }
                },
                "pagination": {
        ...
        "UsersMeLeaderboardPositionsGetHandler.LeaderboardPosition": {
            "type": "object",
            "properties": {
                "language": {
                    "type": "string",
        ...
        "UsersMeLeaderboardPositionsGetHandler.ResponseBody": {
            "type": "object",
            "properties": {
                "leaderboardPositions": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/UsersMeLeaderboardPositionsGetHandler.LeaderboardPosition"
                    }
                }
            }
        },
        "UsersMeLessonProgressGetHandler.LessonProgressMap": {
            "type": "object",
            "additionalProperties": {
                "$ref": "#/definitions/UsersMeLessonProgressGetHandler.LessonStepProgressMap"
            }
        },
        "UsersMeLessonProgressGetHandler.LessonStepProgressMap": {
            "type": "object",
            "additionalProperties": {
                "$ref": "#/definitions/UsersMeLessonProgressGetHandler.StepResult"
            }
        },
        "UsersMeLessonProgressGetHandler.ResponseBody": {
            "type": "object",
            "additionalProperties": {
                "$ref": "#/definitions/UsersMeLessonProgressGetHandler.LessonProgressMap"
            }
        },
        "UsersMeLessonProgressGetHandler.StepResult": {
            "type": "object",
            "properties": {
                "accuracy": {
                    "type": "number",
        ...
        "UsersMeLessonProgressPostHandler.RequestBody": {
            "type": "object",
            "properties": {
                "accuracy": {
                    "type": "number",
        ...
        "UsersMyStatisticsPostHandler.LeaderboardRankChanged": {
            "type": "object",
            "properties": {
                "from": {
                    "type": "integer",
        ...
        "UsersMyStatisticsPostHandler.ResponseBody": {
            ...
            "properties": {
                ...
                "leaderboardRankChanged": {
                    "$ref": "#/definitions/UsersMyStatisticsPostHandler.LeaderboardRankChanged"
                },
                "wpmShift": {
                    "type": "number"
                }
        ...
        "UsersUsernameAvailabilityGetHandler.ResponseBody": {
            "type": "object",
            "properties": {
                "available": {
                    "type": "boolean"
        ...
        "UsersUsernameProfileGetHandler.LeaderboardPosition": {
            "type": "object",
            "properties": {
                "language": {
                    "type": "string",
        ...
        "UsersUsernameProfileGetHandler.Profile": {
            ...
            "properties": {
                ...
                "leaderboardPositions": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/UsersUsernameProfileGetHandler.LeaderboardPosition"
                    }
                },
                "personalBests": {
                    "type": "array",
